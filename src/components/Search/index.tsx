...
const Search = ({ value, setValue, width }: { value: string, setValue: (value: string) => void, width?: string }) => {
   ...
   return (
      <div className='flex gap-4 justify-center items-center rounded-xl p-2.5 mx-auto outline-[#c2c7cc] outline-1 outline-none -outline-offset-1 mb-16 focus-within:!outline-secondary/40 max-w-[100vw] overflow-x-auto px-4' style={{ width: width ?? '600px' }} >
