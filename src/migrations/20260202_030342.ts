...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TABLE "pages_blocks_carousel_slides_items" (
  ...
  CREATE TABLE "_pages_v_blocks_carousel_slides_items" (
  	"_order" integer NOT NULL,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "pages_blocks_carousel_slides_items" CASCADE;
  DROP TABLE "pages_blocks_carousel_slides" CASCADE;
  DROP TABLE "_pages_v_blocks_carousel_slides_items" CASCADE;
