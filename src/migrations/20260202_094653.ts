...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_pages_blocks_carousel_slides_direction" AS ENUM('slide-to-right', 'slide-to-left');
  CREATE TYPE "public"."enum__pages_v_blocks_carousel_slides_direction" AS ENUM('slide-to-right', 'slide-to-left');
